...
/*   Updated: 2022/12/15 10:44:28 by skoulen          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fdf.h"

static void	plotLineLow(t_point p0, t_point p1, t_data *data)
{
	int	dx = p1.x - p0.x;
	int	dy = p1.y - p0.y;
	int yi = 1;
...
static void	plotLineHigh(t_point p0, t_point p1, t_data *data)
{
	int	dx = p1.x - p0.x;
	int	dy = p1.y - p0.y;
	int xi = 1;
